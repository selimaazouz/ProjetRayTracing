...
class Mobile_Sphere : public Object{
    public:
        ...
        Mobile_Sphere(
            ...
            : center0(c0), center1(c1), time0(t0), time1(t1), radius(r), materiau_ptr(m)
        {};
		...
		virtual bool bounding_box(
            double t0, double t1, BoundingBox& ob) ;
...
bool Mobile_Sphere::intersect(const rayon& r, double t_min, double t_max, EnregIntersect& record) {
    vecteur3 oc = r.origine() - center(r.temps());
...
bool Mobile_Sphere::bounding_box(double t0, double t1, BoundingBox& ob)  {
    BoundingBox b0(
...
tinyxml2::XMLElement* Mobile_Sphere::to_xml(tinyxml2::XMLDocument& xmlDoc)  {
